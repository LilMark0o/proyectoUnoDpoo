...
public class GraficaServiciosCantidad {

    public GraficaServiciosCantidad() {
    ...
    public static DefaultCategoryDataset createDataset() {
        ...
        HashMap<String, Integer> dataSetAUsar = Servicios.dataForGraphZwei();
        for (java.util.Map.Entry<String, Integer> entry : dataSetAUsar.entrySet()) {
            String nombreProducto = entry.getKey();
            Integer Cantidad = entry.getValue();
            dataset.addValue(Cantidad, "Cantidad", nombreProducto);
        }
        return dataset;
    }
    ...
    public static JFreeChart createChart(DefaultCategoryDataset dataset) {
        JFreeChart chart = ChartFactory.createBarChart(
                "Cantidad por Producto/Servicios", // Título de la gráfica
